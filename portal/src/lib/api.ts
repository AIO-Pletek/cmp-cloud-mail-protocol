...
export interface Domain { id: string; domainName: string; isVerified: boolean; dkimSelector: string; dkimPublicKey: string | null; spfRecord: string | null; dmarcRecord: string | null; mxRecord: string | null; isActive: boolean; emailCount: number; spamBlocked: number; createdAt: string; }
