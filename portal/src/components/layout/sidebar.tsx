...
import {
  LayoutDashboard, Globe, Shield, MailWarning, BarChart3, Settings, Mail,
  ChevronLeft, ChevronRight, List, Send, ShieldAlert, ClipboardList,
  Bell, Key, ShieldCheck,
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/rules', label: 'Mail Rules', icon: ShieldCheck },
  ...
  { href: '/enterprise', label: 'Enterprise Gateway', icon: ShieldAlert },
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div>
              ...
              <p className="text-[10px] text-gray-500 -mt-0.5">Cloud Mail Gateway</p>
            </div>
          )}
        </div>
      </div>
